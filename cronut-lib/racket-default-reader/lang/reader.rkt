...
; cronut/racket-default-reader/lang/reader
;
; The language `#lang cronut/racket-default-reader`, which defines a
; Cronut module in a way that reuses Racket's reader rather than
; performing its own text processing.
...
; TODO: Implement `#lang cronut/racket-default-reader` in a way that
; isn't just a placeholder, and write documentation for it.
...
(define (get-info key default-value)
  ...
  (case key
    ...
    ;       Cronut-language module directly or interacting with it at
    ;       a REPL.
    ;
    ;   module-language
